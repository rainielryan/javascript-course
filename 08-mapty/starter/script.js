...
console.log('Mappy OOP Foundation');
class Workout {
  date = new Date();
  ...
  constructor(coords, distance, duration) {
    // store the coordinates as an array
    this.coords = coords;
...
class App {
  ...
  constructor() {
    ...
    // add click handlinng for workout list
  ...
  _moveToPopup(e) {
  // find theclosest workout element
  ...
  console.log(`Navigated to ${workout.type} worked at`, workout.coords );
}
  ...
  _loadDefaultMap() {
    ...
    const defaultCoords = [14.6, 120.9];
  ...
  _renderStoredWorkouts() {
    ...
    console.log(`Rendered ${this.#workouts.length} workouts stored.`);
    }
  }
  ...
  _newWorkout(e) {
    // Helper functions
    // validate inputs that they are numbers that make sense
    const validInputs = (...inputs) =>
      inputs.every(inp => Number.isFinite(inp));
    // validate inputs that they are all positive
  ...
  _getLocalStorage() {
    ...
    // parse the JSON data back to objects
